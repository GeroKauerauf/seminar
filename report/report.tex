...
\input{problem-description/problem-description.tex}

% Introduction to Feedforward Networks
% Section - Feedforward networks
\input{feedforward-networks/feedforward-networks.tex}

% \subsection{tf.keras.Sequential}

% Introduction to Deep Learning
% Section - Deep learning
\input{deep-learning/deep-learning.tex}

% Subsection - Cost Functions
\input{deep-learning/cost-functions.tex}

% Subsection - Computational Graphs
\input{deep-learning/computational-graphs.tex}

% Subsection - Back-Propagation
\input{deep-learning/back-propagation.tex}

% Subsection - Stochastic gradient descent
\input{deep-learning/stochastic-gradient-descent.tex}
